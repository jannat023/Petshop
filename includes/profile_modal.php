...
<!-- Payment Popup -->
<!-- <div class="modal fade" id="paypop">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" align="center"><b>Payment Confirmations</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="paymentSuccess.php" enctype="multipart/form-data">
                ...
                <div class="form-group" align="center">
                    <label for="date_time" class="d-flex justify-content-center"><span id='date-time'></span></label>
                    <script>
                    var dt = new Date();
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-success btn-flat" name="pay"><i class="fa fa-check-square-o"></i> Pay</button>
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              </form>
            </div>
        </div>
